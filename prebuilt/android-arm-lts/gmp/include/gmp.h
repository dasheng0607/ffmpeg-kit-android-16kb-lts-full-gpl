...
#define __GMP_CC "armv7a-linux-androideabi23-clang"
#define __GMP_CFLAGS "-march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -DFFMPEG_KIT_ARM_V7A -std=c99 -Wno-unused-function -fstrict-aliasing -DANDROID_NDK -fPIC -DANDROID -DFFMPEG_KIT_LTS -D__ANDROID__ -D__ANDROID_MIN_SDK_VERSION__=23 -Os -ffunction-sections -fdata-sections  "
